...
var SvgAirplay = function SvgAirplay(props) {
  return React.createElement(
    ...
    React.createElement(
      "defs",
      null,
      React.createElement("path", { id: "airplay_svg__a", d: "M0 0h24v24H0V0z" })
    ),
    React.createElement(
      "defs",
      null,
      React.createElement("path", { id: "airplay_svg__c", d: "M0 0h24v24H0V0z" })
    ),
    React.createElement(
      "clipPath",
      { id: "airplay_svg__b" },
      React.createElement("use", { xlinkHref: "#airplay_svg__a", overflow: "visible" })
    ),
    React.createElement(
      "clipPath",
      { id: "airplay_svg__d", clipPath: "url(#airplay_svg__b)" },
      React.createElement("use", { xlinkHref: "#airplay_svg__c", overflow: "visible" })
    ),
