...
fs.readdir(sourceDir, function(err, files) {
  ...
  files.forEach(function(file) {
    ...
    fs.readFile(filePath, "utf8", function(err, data) {
      ...
      const fileExtension =
        fileCapitalized.substr(0, fileCapitalized.lastIndexOf(".")) + ".js";
      const sourceFileCapitalized = path.join(
        __dirname + "/source/tokens",
        fileExtension
      );
      ...
      fs.readFile(sourceFileCapitalized, "utf8", function(err, jsData) {
        ...
        // Save the file
        fs.writeFile(
          sourceFileCapitalized,
          defaultColorReplaced,
          "utf8",
          function(err) {
